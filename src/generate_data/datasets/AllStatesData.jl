...
function fill_surrogate_data!(
    ...
    for (device_name, orientation_details) in device_details
        ...
        _fill_states_data!(states_data_dict, results, device, save_indices, orientation_details, data_collection_params, sys)
    end 
...
function _fill_states_data!(states_data_dict, results, device::S, save_indices, orientation_details, data_collection_params, sys) where {S <: PSY.StaticInjection}
